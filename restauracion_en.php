        ...
        <div class="row">
                <div class="col d-flex flex-row">
                    <div class="user_box ml-auto">
                        <div class="user_box_login user_box_link"><a href="restauracion.php"><img class="margin-top" src="images/spain.png" alt=""></a></div>
                        <div class="user_box_register user_box_link"><a href="restauracion_en.php"><img class="margin-top" src="images/united-kingdom.png" alt=""></a></div>
                    </div>
                </div>
        </div>
    </div>
